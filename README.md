...
## 技术亮点
1. **分层架构**：Controller - Service - Mapper 清晰分层，代码结构规范
2. **缓存优化**：合理使用 Redis 缓存，显著提升查询性能
3. **日志增强**：AOP 切面记录操作日志，便于问题追踪和审计
4. **安全认证**：JWT 无状态认证 + BCrypt 密码加密，保证系统安全
5. **异常处理**：全局异常统一处理，提供友好的错误提示